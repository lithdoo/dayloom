...
dayloom 的 **World 存档**通用约定：**一切叙事推进与历史归档均以「天」为单位**。依据 [`../README.md`](../README.md) 第 7～11 节、第 13 节整理；本 spec 随协议演进逐步补全字段 schema。
...
存档协议定义见 dayloom 包 [`prompts/spec.md`](./spec.md)，**不参与** `<world_root>/` 运行时加载。
