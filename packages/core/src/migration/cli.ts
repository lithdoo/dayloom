...
async function main(argv: string[]): Promise<void> {
  if (argv.length === 0 || argv.includes('--help')) { process.stdout.write('Usage: dayloom-core archive migrate-world-profile-v1 --source <legacy-world> --target <archive-v2-world>\n'); return; }
