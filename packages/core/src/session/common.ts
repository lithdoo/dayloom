...
Report what Final needs without referring to hidden Thought, prior analysis, tool work, or "the above". Do not answer the user and do not claim that Core has published anything.
