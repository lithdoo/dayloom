...
import { createSessionWorkspace, FINAL_VISIBILITY_NOTE, OBSERVE_HANDOFF_AUTHORITY_NOTE, SUMMARY_SYSTEM_PROMPT, WRITABLE_SUMMARY_AUTHORITY_NOTE, type CoreSession, type SessionToolingBinding } from './common';
import { composeThoughtPrompt } from './prompts/common';
import { ARCHIVE_THOUGHT_POLICY } from './prompts/archive';
import { PLAY_SESSION_ROLE } from './prompts/play';
import { FINAL_DISCIPLINE } from './prompts/final';

export { SUMMARY_SYSTEM_PROMPT, WRITABLE_SUMMARY_AUTHORITY_NOTE };

export const THOUGHT_PROMPT = composeThoughtPrompt(`${PLAY_SESSION_ROLE}\n\n${WRITABLE_SUMMARY_AUTHORITY_NOTE}`, ARCHIVE_THOUGHT_POLICY);
