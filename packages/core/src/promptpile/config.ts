...
export async function writeSummaryConfig(config: CallerConfig, target: string): Promise<void> { await writeFile(target, TOML.stringify(deriveSummaryConfig(config)), 'utf8'); }
