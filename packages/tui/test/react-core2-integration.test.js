...
const { archiveFixture } = require('../../core2/test/helpers.js');
const driverModule = new URL('../dist/runtime-driver/create-runtime-driver-from-core-for-test.js', import.meta.url);

test('real Promptpile React streams Thought Observe Check and Final through Core2 into TUI presentation', { timeout: 25_000 }, async (t) => {
