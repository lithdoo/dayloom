...
${FINAL_VISIBILITY_NOTE}
Return exactly one PlaySubmissionV2 JSON object and nothing else. Do not use Markdown fences. Use pinned beat, character and location ids exactly. Core2 generates event ids. Proposed patches describe candidate changes only; Settle applies them later.
${OBSERVE_HANDOFF_AUTHORITY_NOTE}
${WRITABLE_SUMMARY_AUTHORITY_NOTE}
